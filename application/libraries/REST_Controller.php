...
abstract class REST_Controller extends CI_Controller
{
    ...
    /**
     * The LDAP Distinguished Name of the UserAPI post authentication
     *
     * @var string
     */
    ...
    protected function _perform_ldap_auth($username = '', $password = NULL)
    {
        ...
        if (($res_id = ldap_search($ldapconn, $ldap['basedn'], "uid=$username")) === FALSE) {
            log_message('error', 'LDAP Auth: UserAPI ' . $username . ' not found in search');
            return FALSE;
        }
        ...
        // UserAPI found, could not authenticate as user
