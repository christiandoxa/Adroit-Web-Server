<div class="col-lg-4">
    ...
    ?>
    <form style="padding-bottom: 10%" method="post" action="<?php echo base_url() ?>dashboard/add_perangkat"
          enctype="multipart/form-data">
        <div class="form-group">
            <label>Device Id</label>
            <input class="form-control" id="deviceid" name="deviceid" placeholder="Contoh: batman" required>
        </div>
        <div class="form-group">
