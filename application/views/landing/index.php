...
<script>
        ...
        $("#contact-form").validate({
            ...
            submitHandler: function (form) {
                $(form).ajaxSubmit({
                    type: "POST",
                    data: $(form).serialize(),
                    url: "<?php echo base_url()?>landing/message",
                    success: function () {
        ...
        $("#subscribe").validate({
            submitHandler: function (form) {
                $(form).ajaxSubmit({
                    type: "POST",
                    data: $(form).serialize(),
                    url: "<?php echo base_url()?>landing/subscribe_email",
                    success: function () {
    ...
    function get_started() {
        ...
        swal.queue(steps).then(function (result) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url()?>landing/subscribe',
                data: data,
                success: function () {
                    swal({
                        title: 'Terima kasih!',
                        text: result[0] + ' telah terdaftar dalam sistem kami.',
                ...
                error: function () {
                    swal({
                        title: 'Mohon maaf!',
                        text: result[0] + ' belum terdaftar dalam sistem kami. Silahkan coba lagi.',
                        confirmButtonText: 'OK!',
                        showCancelButton: false
                    })
                }
